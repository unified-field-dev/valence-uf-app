...
use crate::pages::trait_index::components::*;
...
#[component]
pub fn ValenceTraitIndexPage() -> impl IntoView {
    ...
    view! {
        <div id="valence-traits-page">
        <ContentContainer data_testid="trait-index-page">
            <Flex vertical=true gap=SpacingSize::Size240.flex_gap()>
                <div id="valence-traits-list">
                    <TraitsListSection initial_quick_search=initial_quick_search />
                </div>
            </Flex>
        </ContentContainer>
        </div>
